...
class DriversControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create driver" do
    assert_difference('Driver.count') do
      post drivers_url, params: { driver: { firstname: @driver.firstname, lastname: @driver.lastname } }
    end
  ...
  test "should update driver" do
    patch driver_url(@driver), params: { driver: { firstname: @driver.firstname, lastname: @driver.lastname } }
